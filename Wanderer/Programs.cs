...
namespace Wanderer
{
    ...
    {
        public Programs(string[] vertexSource, string[] fragmentSource)
        {
            ...
            using (Objects vObject = new Objects(ShaderType.VertexShader, vertexSource))
            using (Objects fObject = new Objects(ShaderType.FragmentShader, fragmentSource))
            {
                // Create program
